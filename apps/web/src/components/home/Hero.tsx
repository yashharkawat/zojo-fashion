...
export function Hero() {
  ...
  return (
    <section
      ...
      className="hero-cinematic relative w-full overflow-hidden bg-bg-base grain vignette md:h-[92svh] md:min-h-[560px]"
    >
      ...
      {/* Content */}
      <div className="relative z-10 mx-auto flex max-w-7xl flex-col items-start px-4 py-14 md:h-full md:justify-center md:py-0">
        <motion.p
